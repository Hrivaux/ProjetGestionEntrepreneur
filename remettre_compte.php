...
#																				 #
#																				 #
#	ALTER TABLE utilisateurs ADD COLUMN archive ENUM('0', '1') DEFAULT '0';		 #
#																				 #
#																				 #
##################################################################################
*/
                                ...
                                <div class="col-xl-8 col-md-6">
                                    <div class="card Recent-Users">
                                        <div class="card-header">
                                            <h5>Tous les utilisateurs archivés</h5>
                                        </div>
                                        <div class="card-block px-0 py-3">
                                            <div class="table-responsive">
                                                <table class="table table-hover">
                                                    <tbody>
                                                    <?php
                                                    $requete = ("SELECT * FROM utilisateurs WHERE archive = '1'");
                                                    ...
                                                    ?>
                                                        <tr class="unread">
                                                            ...
                                                            <td><?php if ($grade_encours > $users['grade']) { ?><a href="inc/actions/remettre_user.php?id=<?php echo $users['id'];?>" class="label theme-bg2 text-white f-12">Remettre</a></td><?php } ?>
                                                        </tr>
                                                    <?php } } ?>
                                                    </tbody>
                                                </table>
